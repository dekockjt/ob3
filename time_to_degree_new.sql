...
with term as (
    ...
    select
        ...
        (   -- first term not matching legacy codes OR first term showing transfer
            ...
            -- a is current term, z is min term
            ...
            -- min term >= max term with new student type
            ...
            --     (
            --         a.sgbstdn_levl_code = 'UG'
            --         and y.sgbstdn_levl_code = a.sgbstdn_levl_code
            --         and (
            --             (a.sgbstdn_degc_code_1 like 'B%' and y.sgbstdn_degc_code_1 like 'B%')
            --             or (a.sgbstdn_degc_code_1 = 'CERT' and y.sgbstdn_degc_code_1 = 'CERT')
            --         )
...
--  where student_id = '000074895'
-- where student_level = 'PL'
-- and student_id = '000714023'/
-- and terms_enrolled = 3
...
select * from stvstst where stvstst_code like 'N%';
select * from stvstst where stvstst_desc like '%Closed%';
select stvstst_code from stvstst where stvstst_reg_ind = 'Y';

select * from stvstst where stvstst_code like 'C%';
select * from stvdegc where stvdegc_code like 'C%';
select * from sgbstdn where sgbstdn_term_code_eff = '202620';
